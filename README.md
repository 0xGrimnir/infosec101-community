...
| Marley | [@mkr_ultra](https://twitter.com/mkr_ultra) | First place champ, Crying About Space, '08-'18. Tequila & mezcal fan. Advocate for weaponizing the blue team. Actual space marshmallow. 🍤 |
...
| Twitter Name | Twitter Handle | Twitter Biography |
| :---: | :---: | :---: |
| Lenny Zeltser | [@lennyzeltser](https://twitter.com/lennyzeltser) | Advances information security. Grows tech businesses. Fights malware. // VP of Products @MinervaLabs. Author and Instructor @SANSInstitute. |
| MalwareTech | [@MalwareTechLab](https://twitter.com/MalwareTechLab) | Botnet Tracking, Malware Reversing, Programming. Personal account is @MalwareTechBlog. |
| Miss Malware | [@Miss_Malware](https://twitter.com/Miss_Malware) | #CPA gone dark. #Infosec Engineer n00b. Working on my #OSCP. #BlueTeam Learning SEIM and IDS right now. http://keybase.io/missmalware  |
| Brian Carrier | [@carrier4n6](https://twitter.com/carrier4n6) | VP Digital Forensics at Basis Technology. Builds incident response (Cyber Triage) and Digital Forensics software (Autopsy and @sleuthkit) |
| Paul Burbage | [@hexlax](https://twitter.com/hexlax) | Malware researcher @FlashpointIntel \| board member @BSidesCHS \| botnet tracker \| honeypot junkie. Tweets are my own. I'm also hexlax on keybase. |
| Amanda Rousseau | [@malwareunicorn](https://twitter.com/malwareunicorn) | Malware Research Unicorn @EndgameInc. Interested in Malware, Reverse Engineering, and Fashion. DEF CON. My thoughts are my own. @VanitySec Creator |
| Brad | [@malware_traffic](https://twitter.com/malware_traffic) | Sharing information on malicious network traffic and malware samples |
| Jared Atkinson | [@jaredcatkinson](https://twitter.com/jaredcatkinson) | \| Minesweeper Champ \| Aspiring Beard Model \| PowerShell MVP \| PowerForensics \| USAF Vet \| FC Bayern Fan \| 🇳🇴 Språkstudent |
| Hasherezade | [@hasherezade](https://twitter.com/hasherezade) | Programmer, #malware analyst. Author of #PEbear, #PEsieve, #libPeConv. Private account. All opinions expressed here are mine only (not of my employer etc) |
| R136a1 | [@TheEnergyStory](https://twitter.com/TheEnergyStory) | Malware Researcher at Palo Alto Networks |
| Sev | [@sudosev](https://twitter.com/sudosev) | Security Researcher @ ProofPoint. Malware analysis/Threat intel/Sig dev. Tweets are my own - personal account. |
| \_Veronica_ | [@verovaleros](https://twitter.com/verovaleros) | Woman. Hacker. Disruptor. Mentor. Speaker. Malware Researcher. Network Security. Studying Remote Access Trojans. // Co-founder of @womenintechfund & @mateslab |
| VirusShare | [@VXShare](https://twitter.com/VXShare) | Online malware repository project created and maintained by @Forensication PGP 0x37D85B42 |
| Ronnie T. | [@iHeartMalware](https://twitter.com/iHeartMalware) | Python and malware...delicious malware... |
| malware.lu | [@malwarelu](https://twitter.com/malwarelu) | Malware.lu is a repository of malware and technical analysis. The goal of the project is to provide samples and technical analysis to security researcher. |
| Adam | [@Hexacorn](https://twitter.com/Hexacorn) | ROI-oriented DFIR/RCE consulting. Follow my priv blog about expat/travel @pickie_piggie + my wife's art/writing blog @MariNomadie |
| Michael Sikorski | [@mikesiko](https://twitter.com/mikesiko) | Malware Analyst. Triathlete. |
| David Cowen | [@HECFBlog](https://twitter.com/HECFBlog) | SANS Certified Instructor, Expert Witness, Hacking Exposed Computer Forensics author and Blog author |
| Teru Yamazaki | [@4n6ist](https://twitter.com/4n6ist) | Forensic Investigator? Instructor? Researcher? |
| Jérôme Segura | [@jeromesegura](https://twitter.com/jeromesegura) | Lead Malware Intelligence Analyst @Malwarebytes. |
| Nicolas Brulez | [@nicolasbrulez](https://twitter.com/nicolasbrulez) | #Virus #HEXorcist. Armadillo PE protector co-coder. Reverse Engineering Rockstar. First REcon trainer since 2005. Ex Principal Malware Researcher at Kaspersky |
| Sarah Edwards | [@iamevltwin](https://twitter.com/iamevltwin) | Mac Nerd, Forensic Analyst, @sansforensics Author/Instructor of FOR518 Mac/iOS Forensic Analysis & IR, nap aficionado, and animal cuddler. Opinions are mine. |
| Jake Williams | [@MalwareJake](https://twitter.com/MalwareJake) | @RenditionSec. GSE #150. I do adversary emulation, incident response, and malware research. Let's have some adult discussions about information security! |
| x0rz | [@x0rz](https://twitter.com/x0rz) | Security Researcher & Cyber Observer (pgp: 0xdd1190a656721c4a) |
| Alexandre Borges | [@ale_sp_brazil](https://twitter.com/ale_sp_brazil) | Malware Researcher. Instructor, Consultant and Speaker. LinkedIn: in/aleborges |
| Cindy Murphy | [@CindyMurph](https://twitter.com/CindyMurph) | President-Gillware Digital Forensics, Madison WI - 'The most pathetic person in the world is someone who has sight, but has no vision.' Helen Keller |
| Jakub Kroustek | [@JakubKroustek](https://twitter.com/JakubKroustek) | Malware exorcist / ɘƨɿɘvɘЯ engineer / Researcher / Avast Threat Intel lead (previously AVG). My tweets are obviously mine. |
| Tim Strazzere | [@timstrazz](https://twitter.com/timstrazz) | Mobile Security Researcher and Malware Analyst, Tweets are my own not my employers |
| Kyle Hanslovan | [@KyleHanslovan](https://twitter.com/KyleHanslovan) | Malware Connoisseur. Ethical Hacker. CEO at @HuntressLabs. Open DMs. |
